# FULL CODE STACK (SUN-27-JULY-2025-01-25-PM)
...
---
 /* --- [ edit-listing-html-1a: Local Styles ] --- */
  .action-form {
    width: 100%;
  }
  .form-col {
  ...
  /* When swapping, hide button text and show spinner */
  .swapping .swap-btn {
    color: transparent;
  }
        ...
        {% for m in mockups %}
          <div class="mockup-card" id="mockup-card-{{ m.index }}">
            {% if m.exists %}
              ...
              <a
                href="{{ url_for('static', filename=full_rel) ~ '?t=' ~ cache_ts }}"
              ...
              >
                <img
                  ...
                  data-fallback="{{ url_for('static', filename=full_rel) ~ '?t=' ~ cache_ts }}"
