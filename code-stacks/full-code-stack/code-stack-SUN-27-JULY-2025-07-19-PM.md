# FULL CODE STACK (SUN-27-JULY-2025-07-19-PM)
...
{% block content %}
<div class="container">
  <!-- === [ edit-listing-html-2: Page Header ] === -->
  <div class="home-hero">
    <h1>
      <img
  ...
  <!-- === [ edit-listing-html-3: Flash Messages ] === -->
  ...
  <!-- === [ edit-listing-html-4: Main Grid Layout ] === -->
  <div class="review-artwork-grid row">
    <!-- === [ 4a: Left Column - Artwork & Mockups ] === -->
       ...
       <div class="mockup-preview-grid">
        {% for m in mockups %}
          <div class="mockup-card" id="mockup-card-{{ m.index }}">
            {% if m.exists %}
              {% set thumb_url = url_for('artwork.serve_mockup_thumb', seo_folder=seo_folder, filename=m.thumb.name) %}
              {% set full_url = url_for('artwork.processed_image', seo_folder=seo_folder, filename=m.path.name) %}
              {# In templates/edit_listing.html #}
                  <a
                ...
                <div class="thumb-note">Click for full-size</div>
              </a>
    ...
    <!-- === [ 4b: Right Column - Metadata Form & Actions ] === -->
  ...
  <!-- === [ edit-listing-html-5: Modal Carousel ] === -->
...
<!-- === [ edit-listing-html-6: JavaScript Includes ] === -->
<script>
...
<body data-analysis-status-url="{{ url_for('artwork.analysis_status') }}" data-openai-ok="{{ 'true' if openai_configured else 'false' }}" data-google-ok="{{ 'true' if google_configured else 'false' }}">
    ...
    <div id="analysis-modal" class="modal-bg" role="dialog" aria-modal="true">
        <div class="modal-box" tabindex="-1">
            ...
            <div class="modal-progress" aria-label="analysis progress">
                <div id="analysis-bar" class="modal-progress-bar" role="progressbar" aria-valuenow="0"></div>
            </div>
            <div class="modal-friendly-text">Grab a coffee while AI works it's magic!<br>Usually only takes a minute or two!</div>
