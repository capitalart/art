# FULL CODE STACK (THU-24-JULY-2025-06-39-PM)
      ...
      <div class="mockup-preview-grid">
        {% for m in mockups %}
          <div class="mockup-card">
            ...
            {% else %}
              <img src="{{ url_for('static', filename='img/default-mockup.jpg') }}" class="mockup-thumb-img" alt="Default Mockup" width="300" height="300">
            {% endif %}
