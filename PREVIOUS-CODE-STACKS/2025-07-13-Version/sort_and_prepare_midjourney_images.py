...
# === [ ART Narrator Lite: CONFIGURATION ] ===
...
# === [ ART Narrator Lite: UTILITY FUNCTIONS ] ===
...
# === [ ART Narrator Lite: MAIN PROCESS ] ===
...
def process_images():
    ...
    """
    print("🧠 Starting ART Narrator Lite: Image Sort, Rename, and Metadata Generation...")
    ...
    try:
        ...
        print(f"\n📦 ART Narrator Lite process complete!")
