...
# === [ ArtNarrator Lite: CONFIGURATION ] ===
...
# === [ ArtNarrator Lite: UTILITY FUNCTIONS ] ===
...
def process_images():
    ...
    """
    print("🧠 Starting ArtNarrator Lite: Image Sort, Rename, and Metadata Generation...")
    ...
    try:
        ...
        print(f"\n📦 ArtNarrator Lite process complete!")
