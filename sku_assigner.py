"""
sku_assigner.py — Robust SKU assignment for ArtNarrator/CapitalArt/DreamArtMachine.
Finds the max used SKU in all listing files, assigns the next sequential SKU,
ignores gaps, and never creates duplicates. Tracker file is used for speed only.
"""
...
def get_next_sku(tracker_path: Path, listings_root: Path) -> str:
    ...
    # File-lock for safety on concurrent runs
